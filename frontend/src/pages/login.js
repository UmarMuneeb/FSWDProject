            ...
            <div className='w-7/12'>
                ...
                <div className='flex w-full h-3/6 pt-20 justify-center items-center flex-col gap-5'>
                    <div>
                        ...
                        <div className='pt-4'>
                            <button className='w-64 bg-green-500 text-white font-extrabold rounded-md border-black p-1 border-2' onClick={()=>navigate('/')}>Login</button>
                        </div>
                        <div className='pt-2'>
                            <p className='text-sm font-bold'>Dont Have an Account? <button className='text-blue-600' onClick={()=>navigate('/SignUp')}>SignUp</button></p>
                        </div>
